...
INSERT INTO `COURSEMODULE` VALUES (1,'Java'),(2,'Research'),(3,'HCI'),(4,'Design Patterns');
...
INSERT INTO `EXAMPAPER` VALUES (1,'2014-11-01',1),(2,'2014-10-28',2),(3,'2014-11-02',3),(4,'2014-10-30',2);
/*!40000 ALTER TABLE `EXAMPAPER` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `EXAMPAPER_SECTION`
--

DROP TABLE IF EXISTS `EXAMPAPER_SECTION`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `EXAMPAPER_SECTION` (
  `ExamPaper_ID` bigint(20) NOT NULL,
  `sections_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ExamPaper_ID`,`sections_ID`),
  KEY `FK_EXAMPAPER_SECTION_sections_ID` (`sections_ID`),
  CONSTRAINT `FK_EXAMPAPER_SECTION_sections_ID` FOREIGN KEY (`sections_ID`) REFERENCES `SECTION` (`ID`),
  CONSTRAINT `FK_EXAMPAPER_SECTION_ExamPaper_ID` FOREIGN KEY (`ExamPaper_ID`) REFERENCES `EXAMPAPER` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `EXAMPAPER_SECTION`
--

LOCK TABLES `EXAMPAPER_SECTION` WRITE;
/*!40000 ALTER TABLE `EXAMPAPER_SECTION` DISABLE KEYS */;
/*!40000 ALTER TABLE `EXAMPAPER_SECTION` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `EXAMSESSION` VALUES (1,'2014-11-03',3,'ISS','18:00:00',1,1),(2,'2014-11-03',3,'ISS','19:00:00',2,2);
...
INSERT INTO `STUDENT` VALUES (1,'Abhinav',1),(2,'Nisith',2);
...
INSERT INTO `USER` VALUES (1,'Y','abhinav','password','student'),(2,'Y','nisith','password','student'),(3,'N','a','password','lecturer');
...
-- Dump completed on 2014-11-03 16:04:46
